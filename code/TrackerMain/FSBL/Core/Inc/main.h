...
#define DIV_FACTOR(SRC, DST) \
    (((uint32_t)((1024 * DST) / SRC)) > 1023 ? 1023 : \
    ((uint32_t)((1024 * DST) / SRC)))

#define DOWNSCALE_RATIO(SRC, DST) \
    (((uint32_t)(((float_t)(SRC) / (float_t)(DST)) * 8192) < 8192) ? 8192 : \
